 ...
 * If there are 26 rows (0 to 25) and 100 seats (0 to 99) in each row, write a nested for loop to print 
 * out all of the different seat combinations in the theater.
